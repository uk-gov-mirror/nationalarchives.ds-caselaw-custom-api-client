...
- **Document**: validate metadata field IDs before materialisation during `save()`
...
- If there's an email date, use it to populate the submitted date

## v44.4.4 (2026-02-19)

- Ensure stub XML is generated by XML compliant tooling
...
- Support lazy loading of images in HTML output

### Fix

- Don't create blank uk:jurisdiction tags when updating edited metadata
- Assume press summaries always have content
- Lazy load images
...
- **MarklogicApiClient**: add new method to retrieve list of document locks

## v44.1.1 (2025-12-04)

### Fix

- reparse queue queries now correctly handle major version bumps

## v44.1.0 (2025-12-01)

- Method to allow uploading a PDF assets to S3 (for editor UI)
